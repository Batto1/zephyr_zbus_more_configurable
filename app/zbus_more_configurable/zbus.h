...
#if defined(CONFIG_ZBUS_MORE_CONFIG_RUNTIME_OBSERVERS) || defined(__DOXYGEN__)
 ...
 */
struct zbus_channel {
#if defined(CONFIG_ZBUS_MORE_CONFIG_CHANNEL_NAME) || defined(__DOXYGEN__)
	/** Channel name. */
...
#if defined(CONFIG_ZBUS_MORE_CONFIG_OBSERVER_NAME) || defined(__DOXYGEN__)
	/** Observer name. */
	const char *const name;
#endif
	/** Type indication. */
...
#if defined(CONFIG_ZBUS_MORE_CONFIG_MSG_SUBSCRIBER) || defined(__DOXYGEN__)
		/** Observer message FIFO. It turns the observer into a message subscriber. It only
		 * exists if the @kconfig{CONFIG_ZBUS_MORE_CONFIG_MSG_SUBSCRIBER} is enabled.
		 */
...
#if defined(CONFIG_ZBUS_MORE_CONFIG_ASSERT_MOCK)
...
#if defined(CONFIG_ZBUS_MORE_CONFIG_CHANNEL_NAME)
...
#if defined(CONFIG_ZBUS_MORE_CONFIG_OBSERVER_NAME)
